...
class Step(models.Model):
    ...
    input_file_step = models.FileField(upload_to='design/', max_length=10000, blank=True)
    input_file_script = models.ForeignKey(File, blank=True, null=True, default=None, on_delete=models.CASCADE)
